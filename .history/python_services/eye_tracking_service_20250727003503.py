                        ...
                        for eye_points in [self.LEFT_EYE, self.RIGHT_EYE]:
                            for point_idx in eye_points:
                                if point_idx < len(self.eye_landmarks):
                                    cv2.circle(self.annotated_frame, self.eye_landmarks[point_idx], 2, (0, 255, 0), -1)cv2.circle(self.annotated_frame, self.eye_landmarks[point_idx], 2, (0, 255, 0), -1)
                ...
                if frame_to_use is not None:
                    ...
                    if len(frame_to_use.shape) == 3:
                        ...
                        success, buffer = cv2.imencode('.jpg', resized_frame, [
                            cv2.IMWRITE_JPEG_QUALITY, 90,  # Higher quality for better visibility
