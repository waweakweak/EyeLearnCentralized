...
<div class="mb-8">
    ...
    try {
        ...
        document.getElementById('test-eye-tracking').addEventListener('click', () => {
            console.log('🧪 Testing eye tracking functionality...');
            
            // Clear session storage to force countdown
            sessionStorage.removeItem(sessionKey);
            ...
            // Create new tracker instance to trigger countdown
            setTimeout(() => {
                window.cvEyeTracker = new CVEyeTrackingSystem(`test_module_${Date.now()}`, 'main_content');
                console.log('✅ New eye tracking instance created with countdown');
            }, 500);
        });
