...
<body class="bg-background">
    ...
    <nav class="fixed top-0 left-0 right-0 h-16 bg-white shadow-md z-30 flex items-center justify-between px-4">
        ...
        <div class="flex items-center space-x-4">
            <!-- Back to Dashboard -->
            <button onclick="handleCourseExit()" class="text-gray-700 hover:text-primary flex items-center mr-2 bg-transparent border-none cursor-pointer" data-manual-exit="true">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function startModuleEyeTracking() {
        ...
        // Store the current module ID in sessionStorage to persist across page navigations
        ...
        if (currentTrackingModule === moduleId && currentTrackingUser === userId.toString()) {
            ...
            // Just start the frame updates without restarting tracking
            if (!moduleFrameUpdateInterval) {
                moduleFrameUpdateInterval = setInterval(updateModuleVideoFrame, 100);
...
async function handleCourseExit() {
    try {
        console.log('🚪 Handling course exit...');
        ...
        if (exitButton) {
            exitButton.innerHTML = `
                ...
                <span class="hidden md:inline">Stopping...</span>
            `;
        ...
        if (typeof CVEyeTrackingSystem !== 'undefined') {
            ...
            console.log('⚠️ CVEyeTrackingSystem not available, proceeding with navigation');
        }
        ...
        }, 1500); // 1.5 second delay to ensure camera shutdown
