...
<body class="bg-background min-h-screen">
                ...
                <div class="space-y-6">
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                            <button type="submit" name="accept_agreement" id="accept-btn" disabled
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Enable accept button when checkbox is checked and camera works
            ...
            checkbox.addEventListener('change', function() {
                if (this.checked && cameraStream) {
                    ...
                    acceptBtn.classList.add('bg-green-600', 'hover:bg-green-700', 'focus:ring-green-500');
                } else {
                    acceptBtn.disabled = true;
                    acceptBtn.classList.add('bg-gray-400', 'cursor-not-allowed');
                    acceptBtn.classList.remove('bg-green-600', 'hover:bg-green-700', 'focus:ring-green-500');
                }
            });
        });
        ...
        async function testCameraAccess() {
            ...
            try {
                ...
                videoEl.onloadedmetadata = () => {
                    ...
                    // Update accept button to show camera is working
                    const acceptBtn = document.getElementById('accept-btn');
                    acceptBtn.innerHTML = `
                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
