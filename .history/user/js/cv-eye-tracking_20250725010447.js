...
class CVEyeTrackingSystem {
    constructor(moduleId, sectionId = null) {
        ...
        this.countdownShownForModule = false; // Track if countdown was shown for this module
        this.metrics = {
            focused_time: 0,
            unfocused_time: 0,
            total_time: 0,
    ...
    showCountdownNotification() {
        // Create centered countdown overlay matching the image design
        const countdownOverlay = document.createElement('div');
        countdownOverlay.id = 'eye-tracking-countdown';
        countdownOverlay.className = 'fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50';
        countdownOverlay.innerHTML = `
            <div class="bg-gray-800 text-white rounded-lg shadow-2xl p-8 text-center" style="width: 300px; height: 300px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                <!-- Header -->
                <div class="flex items-center mb-4">
                    <div class="w-3 h-3 bg-pink-500 rounded-full mr-2"></div>
                    <span class="text-sm font-medium">CV Eye Tracking Initializing</span>
                </div>
                
                <!-- Rocket Icon Container -->
                <div class="mb-6">
                    <div id="countdown-number" class="text-6xl font-bold mb-2">3</div>
                    <div id="rocket-icon" class="text-4xl hidden">🚀</div>
                </div>
                
                <!-- Status Text -->
                <div class="text-sm text-gray-300" id="countdown-status">
                    Preparing camera and gaze detection...
                </div>
            </div>
        `;
        ...
        const countdownInterval = setInterval(() => {
            if (secondsRemaining > 0) {
                ...
                statusText.textContent = 'Launching Eye Tracking! 🚀';
