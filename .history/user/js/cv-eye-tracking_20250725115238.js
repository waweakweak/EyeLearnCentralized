    ...
    showCountdownNotification() {
        ...
        countdownOverlay.innerHTML = `
            <div class="bg-gray-800 text-white rounded-lg shadow-2xl p-6 text-center" style="width: 220px; height: 220px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                ...
                <div class="mb-4">
                    <div id="countdown-number" class="text-4xl font-bold mb-1">2</div>
        ...
        // Start fast countdown sequence: 2, 1, rocket
        ...
        const countdownInterval = setInterval(() => {
            if (secondsRemaining > 0) {
                ...
                // Remove countdown overlay quickly after rocket shows
                setTimeout(() => {
        ...
        }, 600); // Faster intervals (600ms instead of 1000ms)
    }
            ...
            if (response.ok) {
                ...
                if (data.success && data.frame) {
                    ...
                    if (videoElement) {
                        ...
                        console.log('🔍 Frame data prefix check:', data.frame.substring(0, 50));
                        ...
                        videoElement.onerror = (error) => {
                            ...
                            console.error('❌ Frame data preview:', data.frame.substring(0, 100) + '...');
