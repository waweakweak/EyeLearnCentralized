        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('📊 Frame data received:', {
                    ...
                    frameDataType: typeof data.frameData,
                    frameDataTruthy: !!data.frameData
                });
                ...
                if (data.success && data.hasFrame === true && data.frameData && data.frameData.length > 0) {
                    ...
                    console.warn('⚠️ Frame condition failed:');
                    console.warn('  - data.success:', data.success);
                    console.warn('  - data.hasFrame:', data.hasFrame, '(type:', typeof data.hasFrame, ')');
                    console.warn('  - data.frameData exists:', !!data.frameData);
                    console.warn('  - data.frameData length:', data.frameData ? data.frameData.length : 'N/A');
