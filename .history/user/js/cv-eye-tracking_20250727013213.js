...
class CVEyeTrackingSystem {
    ...
    drawFrameToCanvas(frameData, canvasElement) {
        ...
        img.onload = () => {
            try {
                ...
                if (!ctx || !canvasElement.parentNode) {
                    console.warn('⚠️ Canvas context lost or element removed');
                    return;
                }
                ...
                // Optimized drawing with error handling
                try {
                    ...
                    // Draw the frame with high quality
                    ...
                    // Don't update lastFrameTime on error to prevent timing issues
                }
        ...
        // Prevent image caching for live feed
