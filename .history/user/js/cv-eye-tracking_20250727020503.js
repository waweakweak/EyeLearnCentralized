                    ...
                    if (videoElement) {
                        ...
                        img.onload = () => {
                            ...
                            if (Math.random() < 0.05) { // 5% chance
                                console.log(`✅ Frame updated continuously (${data.frameData.length} chars)`);
                            }
                        };
                        
                        img.onerror = () => {
                            if (Math.random() < 0.1) { // 10% chance
                                console.warn('⚠️ Frame preload failed - using direct assignment');
                                videoElement.src = data.frameData; // Fallback to direct assignment
                            }
                        };
                        ...
                        // Also set direct assignment as backup (for immediate display)
                        videoElement.src = data.frameData;
                    }
                } else {
                    if (Math.random() < 0.05) { // 5% chance
