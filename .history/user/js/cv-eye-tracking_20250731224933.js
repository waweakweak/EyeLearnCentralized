    ...
    async init() {
        ...
        if (this.isConnected) {
            ...
            if (shouldShowCountdown) {
                ...
                // OPTIMIZATION: Start services immediately, show countdown UI in parallel
                this.markCountdownShownForModule();
                
                // Start all services immediately (no delay)
                await this.startTracking();
                this.setupStatusUpdates();
                this.displayTrackingInterface();
                this.initializeTimers();
                
                // Show countdown notification AFTER services are ready
                this.showCountdownNotification();
                
                console.log('✅ Eye tracking services ready immediately, countdown shown for UX');
            } else {
