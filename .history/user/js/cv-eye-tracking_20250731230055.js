...
// Initialize CV eye tracking when DOM is loaded - OPTIMIZED FOR SEAMLESS TRANSITIONS
        ...
        if (moduleId) {
            ...
            if (window.cvEyeTracker) {
                if (window.cvEyeTracker.moduleId === moduleIdInt) {
                    // Same module - instant section switch
                    console.log('⚡ Same module, instant section switch...');
                    
                    try {
                        await window.cvEyeTracker.switchSection(sectionIdInt);
                        console.log('⚡ Section switch completed instantly');
                        return; // Exit early - seamless transition complete
                    } catch (error) {
                        console.error('❌ Section switch failed:', error);
                        // Fall through to seamless transition
                    }
                } else {
                    // Different module - seamless transition
                    console.log(`⚡ Different module (${window.cvEyeTracker.moduleId} → ${moduleIdInt}), seamless transition...`);
                    
                    try {
                        await window.cvEyeTracker.seamlessTransition(moduleIdInt, sectionIdInt);
            ...
            // Create new tracker (first time or fallback)
            ...
            try {
                ...
                console.log('⚡ New tracker created instantly');
            } catch (error) {
